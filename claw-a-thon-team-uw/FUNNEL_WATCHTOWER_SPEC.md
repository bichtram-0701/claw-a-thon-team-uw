# Funnel Agent - Agent Spec

## Product thesis

Funnel Agent is a closed-loop execution intelligence system for owned funnel metrics. It detects target drift, estimates value at risk, links the problem to Jira ownership, creates or updates accountable recovery work, and prepares weekly operating summaries in Confluence.
...
The current synthetic demo labels the final outcome as `Disbursement`, while the workflow remains configurable for other final-outcome stages in future versions.
