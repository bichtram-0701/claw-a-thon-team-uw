...
Funnel Agent supports natural read-only questions, but for reliable workflow execution use a command prefix plus the request:
...
| Disbursement | Approved users/entities that disburse |
