...
def render_markdown(month: str | None = None) -> str:
    ...
    vol = [
        ...
        line("Disbursement Amount", [_b(x["completion_amount_vnd"]) for x in r], _signed_amount(delta("completion_amount_vnd")), _mom_pct(latest.get("completion_amount_vnd"), prev.get("completion_amount_vnd") if prev else None)),
