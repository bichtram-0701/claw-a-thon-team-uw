...
|---|---|
| `router.py` | Slash-command routing (natural funnel questions, `/jira`, `/confluence`, `/teams`, `/help`, `/model`; `/query` remains an alias) with semantic fallback, warnings, clarification, and write-command guards |
